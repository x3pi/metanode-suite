...
export const WSS_RPC = "ws://192.168.1.231:10746/ws";
export const GO_BACKEND_RPC_URL = "http://192.168.1.231:10746";
...
export const WT_SERVER_CERTIFICATE_HASH = new Uint8Array([
  0xba, 0xfb, 0xba, 0x13, 0x44, 0x0c, 0x44, 0x7c, 0x0c, 0xf4, 0x28, 0xa2,
  0xca, 0xdd, 0xab, 0x76, 0x74, 0x6e, 0x04, 0xe4, 0x72, 0xef, 0x5a, 0x43,
  0x39, 0x04, 0x0d, 0xc4, 0xc0, 0x42, 0xeb, 0x7a
]);
